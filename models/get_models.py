...
def get_model(name: str, distributed: bool) -> Tuple[nn.Module, int]:
    ...
    match name:
        ...
        case "dinov2_vitb":
            model = torch.hub.load(r"models/facebookresearch_dinov2_main", "dinov2_vitb14",source='local')
            num_feat = 768
        ...
        case "vit-b16":
            ...
            model = create_model(
                    ...
                    pretrained=False,  # 会触发加载，但下面覆盖文件路径
                    num_classes=200,
                    drop_rate=0.0,
                    drop_path_rate=0.0,
            ...
            num_feat = 768
            load_checkpoint(model, 'pretrain_model/ViT-B_16.npz')
        case _:
