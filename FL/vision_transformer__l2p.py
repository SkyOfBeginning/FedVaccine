...
class VisionTransformer(nn.Module):
    ...
    # 看这里
    def set_prompt(self,global_prompt):
        self.prompt = copy.deepcopy(global_prompt)


    def forward_features(self, x, cls_features=None, train=False,task_id=-1):
    ...
    def forward(self, x, task_id=-1, cls_features=None, train=False):
        res = self.forward_features(x, cls_features=cls_features, train=train)
